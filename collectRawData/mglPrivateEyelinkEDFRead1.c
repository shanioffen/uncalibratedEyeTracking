...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
  ...
  const char *fieldNamesGaze[] =  {"time","x","y","rawx","rawy","pupil","pix2degX","pix2degY","velocityX","velocityY","whichEye"};
  int outDims2[2] = {1,1};
  mxSetField(plhs[0],0,"gaze",mxCreateStructArray(1,outDims2,11,fieldNamesGaze));
  ...
  mxSetField(mxGetField(plhs[0],0,"gaze"),0,"rawx",mxCreateDoubleMatrix(1,numSamples,mxREAL));
  double *outptrXRaw = (double *)mxGetPr(mxGetField(mxGetField(plhs[0],0,"gaze"),0,"rawx"));
  mxSetField(mxGetField(plhs[0],0,"gaze"),0,"rawy",mxCreateDoubleMatrix(1,numSamples,mxREAL));
  double *outptrYRaw = (double *)mxGetPr(mxGetField(mxGetField(plhs[0],0,"gaze"),0,"rawy"));
    ...
    case SAMPLE_TYPE:
      ...
      *outptrWhichEye++ = currentEye;
      if ((int)data->fs.gx[currentEye]==NaN) {
        ...
        *outptrXRaw++ = (double)data->fs.px[currentEye];
        *outptrYRaw++ = (double)data->fs.py[currentEye];
