...
function analysisForMethodsPaper_03distributions
% ************************************************************************
onKirkwood = 1;
...
for iList = 1:2 % load m, 15 fields: x,y and xy: mean var, max var, integrity, TTA-R2 and R2
    ...
    d{iList}.xyMeanVar = bootstrapDist(m.xymeanVar(:),nboots,nsamples);
    d{iList}.xyIntegrity = bootstrapDist(m.xyTTAintegrity(:),nboots,nsamples);    
